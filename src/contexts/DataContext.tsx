...
interface DataContextType {
  ...
  saveJournalEntry: (title: string, content: string, sentiment: 'positive' | 'neutral' | 'negative') => Promise<void>;
  loading: boolean;
...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const saveJournalEntry = async (title: string, content: string, sentiment: 'positive' | 'neutral' | 'negative') => {
    if (!user) return;
